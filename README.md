"Create Readme" 
We can skip oops and directly go to Data Structure implementation because usse aa jayega
We need STL for node class, templates, Strings, 
Linked Lists
Queues and Stacks
Multi dimensional Arrays : Lecture and then code 

Java Data Structures 
Java Algorithms Practice
- Arrays and Algorithms + Code in Java + Revise 
- Strings 
- Linked Lists
- Queues
- Stacks
